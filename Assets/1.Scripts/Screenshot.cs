...
public class Screenshot : MonoBehaviour
{
   // public GameObject blink;             // 사진 찍을 때 깜빡일 것
    ...
    {
        // 스크린샷
        Texture2D ss = new Texture2D(1000, 1000, TextureFormat.RGB24, false); //카메라가 인식할 영역의 크기
        ss.ReadPixels(new Rect(300, 40, 1000, 1000), 0, 0); // (cameraview UI Pivot 좌하단 기준) 좌표 x,y 입력, 가로 길이, 세로 길이
        ss.Apply();
